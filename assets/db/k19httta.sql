...
(6, 1, 'Số ca nhiễm nCoV lên 194', 'Sáng 30/3, Bộ Y tế ghi nhận thêm 6 ca dương tính nCoV, đều thuộc công ty Trường Sinh, đơn vị cung cấp dịch vụ cho Bệnh viện Bạch Mai.', ' Thứ hai, 30/3/2020, 05:56 (GMT+7) Số ca nhiễm nCoV lên 194  Sáng 30/3, Bộ Y tế ghi nhận thêm 6 ca dương tính nCoV, đều thuộc công ty Trường Sinh, đơn vị cung cấp dịch vụ cho Bệnh viện Bạch Mai.  \"Bệnh nhân 189\" nữ, 46 tuổi, địa chỉ tại Tân Quang, Nông Cống, Thanh Hóa, là nhân viên thuộc bộ phận chuyển phát nước sôi của Công ty TNHH Trường Sinh tại các khoa/phòng Bệnh viện Bạch Mai. Bệnh nhân ở cùng nhà với hai trường hợp làm cùng công ty dương tính với nCoV. Trong hai tuần trở lại đây, bệnh nhân không đi đâu xa khỏi khuôn viên bệnh viện.', '', 0, '', '2020-03-30 01:49:12');
